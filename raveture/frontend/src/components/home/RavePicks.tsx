    ...
    <section className="py-16 px-4 md:px-8 border-t border-border">
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          ...
          <Link
            to="/picks"
            className="text-accent text-xs font-bold uppercase tracking-widest hover:underline hidden md:block"
          >
            VIEW ALL →
          </Link>
        </div>
        ...
        <div className="flex gap-4 overflow-x-auto pb-4 scrollbar-none">
          {picks.map((pick) => (
            ...
            >
              <div className="bg-surface border border-border group-hover:border-accent transition-colors duration-200">
                {pick.event.cover_image_url ? (
                  ...
                  <div className="w-full h-40 bg-bg-dark flex items-center justify-center">
                    <span className="text-accent text-4xl font-black">◆</span>
                  </div>
                )}
                <div className="p-4">
        ...
        <div className="mt-4 text-right md:hidden">
          <Link to="/picks" className="text-accent text-xs font-bold uppercase tracking-widest hover:underline">
            VIEW ALL PICKS →
          </Link>
        </div>
      </div>
